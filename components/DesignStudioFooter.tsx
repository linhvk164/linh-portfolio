...
export function DesignStudioFooter() {
  ...
  return (
    <>
      ...
      <footer
        id="contact"
        className="design-studio-footer w-full scroll-mt-24 overflow-hidden rounded-tl-[2.75rem] rounded-tr-[2.75rem] bg-accent md:rounded-tl-[3.5rem] md:rounded-tr-[3.5rem]"
      >
